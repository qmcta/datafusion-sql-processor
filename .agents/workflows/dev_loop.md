# Workflow: Autonomous Engineering Loop

This workflow orchestrates the end-to-end spec-to-code automated development loop in Antigravity.
...
|                             v
|      +---------------------------------------------+
|      |    Step A: Implement (Developer Agent)      |
|      |    - Read spec.md & test_results.log        |
|      |    - Write / modify Rust code & Cargo.toml   |
|      +---------------------------------------------+
|                             |
|                             v
|      +---------------------------------------------+
|      |    Step B: Audit & Test (QA Agent)          |
|      |    - cargo check, cargo test, cargo clippy  |
|      +---------------------------------------------+
|                             |
|                             v
|      +---------------------------------------------+
|      |          Step C: Loop Evaluation            |
|      +---------------------------------------------+
|               /              |              \
|        [PASS]          [FAIL & < 5]      [FAIL & >= 5]
|          /                   |                 \
|         v                    v                  v
|    +---------+       +---------------+     +-----------+
|    | Success |       | Save log &    |     | Escalate  |
|    | & STOP  |       | iteration++   |     | to Human  |
|    +---------+       +---------------+     +-----------+
|                              |
+------------------------------+
```
